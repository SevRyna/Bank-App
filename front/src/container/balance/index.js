    ...
    <div className="container balance">
      <div className="balance-container">
        <div className="head">
          ...
          <div className="rs">
            <label htmlFor="recieve-button" className="recieve-label">
              Recieve
            </label>
            <Link id="recieve-button" className="recieve" to="/recieve"></Link>
            <label htmlFor="send-button" className="send-label">
              Send
            </label>
            <Link id="send-button" className="send" to="/send"></Link>
          </div>
        </div>
